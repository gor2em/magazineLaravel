            ...
            <div
                ...
                <div class="row">
                    <div class="col-lg-8 cp-r animate-box">
                        ...
                        <p>Even the all-powerful Pointing has no control about the blind texts it is an almost
                            ...
                            the Little Blind Text didn’t listen. </p>
                ...
                <div class="row rp-b">
                    <div class="col-lg-6 col-md-12 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_1.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"
                ...
                <div class="row rp-b">
                    <div class="col-lg-6 col-lg-push-6 col-md-12 col-md-push-0 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_4.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"
                                class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia</figcaption>
                        </figure>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_5.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"
                                class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia</figcaption>
                        </figure>
                    ...
                    <div class="col-md-4 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_6.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"
                                class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia</figcaption>
                        </figure>
                    ...
                    <div class="col-md-4 animate-box">
                        <figure>
                            <img src="{{url('assets/images/pic_7.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co"
                                class="img-responsive">
                            <figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from
                                the countries Vokalia and Consonantia</figcaption>
                        </figure>
